...
def replace_variable_values_with_moving_averages(
...
def _write_saved_model(saved_model_path, trained_checkpoint_prefix, inputs, outputs):
...
def _export_inference_graph(
    ...
    if use_moving_averages:
        ...
        replace_variable_values_with_moving_averages(
            tf.get_default_graph(), trained_checkpoint_prefix, temp_checkpoint_file.name
        )
    ...
    _write_saved_model(saved_model_path, trained_checkpoint_prefix, placeholder_tensor, outputs)
